...
#define MAX_SEM_VAL 10000    // NB is also max for nr elem in msgQ !
...
* @param [nr] number of semaphore. Semaphores are allocated by user buth
...
/**
   ...
   NB no chk if ref to task is valid !!
 **/
